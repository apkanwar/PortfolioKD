...
export default function ContactForm() {
    ...
    return (
        <div id="contact" className="isolate bg-gradient-to-b from-artic-blue to-white px-6 pt-14 sm:py-10 lg:px-8 relative">
            <div className="max-w-7xl mx-auto py-6">
                ...
                <form onSubmit={handleSubmit} className="mx-auto mt-8 max-w-xl sm:mt-12">
                    ...
                    <div className="mt-10">
                        <button type="submit" className="bg-bmo-blue text-white rounded-full py-2.5 px-8 hover:bg-opacity-80 transition-opacity duration-300 text-lg font-medium font-headings w-fit">
                            Send
                        </button>
                    </div>
                </form>
